...
class QueryProcessedImage(_message.Message):
    __slots__ = ["id"]
    ID_FIELD_NUMBER: _ClassVar[int]
    id: str
    def __init__(self, id: _Optional[str] = ...) -> None: ...

class ProcessedImage(_message.Message):
...
class RespuestaProcessedImage(_message.Message):
    __slots__ = ["mensaje", "processed_image"]
    MENSAJE_FIELD_NUMBER: _ClassVar[int]
    RESERVA_FIELD_NUMBER: _ClassVar[int]
    mensaje: str
    processed_image: ProcessedImage
    def __init__(self, mensaje: _Optional[str] = ..., processed_image: _Optional[_Union[ProcessedImage, _Mapping]] = ...) -> None: ...
