from saludtech.modulos.processed_data.dominio.objetos_valor import Odo, ParametroBusca, Segmento, Leg, CodigoIATA, Itinerario
from saludtech.modulos.processed_data.dominio.entidades import Proveedor,Aeropuerto
